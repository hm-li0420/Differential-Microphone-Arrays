...
# ifndef KISS_FFT_MALLOC
#  define KISS_FFT_MALLOC hq_malloc
# endif
# ifndef KISS_FFT_FREE
#  define KISS_FFT_FREE hq_free
# endif
#endif
...
kiss_fft_cfg KISS_FFT_API kiss_fft_alloc_hq(int nfft,int inverse_fft,void * mem,size_t * lenmem);
 ...
 * Note that each element is complex and can be accessed like
    f[k].r and f[k].i
 * */
void KISS_FFT_API kiss_fft_hq(kiss_fft_cfg cfg,const kiss_fft_cpx *fin,kiss_fft_cpx *fout);

/*
 A more generic version of the above function. It reads its input from every Nth sample.
 * */
void KISS_FFT_API kiss_fft_stride_hq(kiss_fft_cfg cfg,const kiss_fft_cpx *fin,kiss_fft_cpx *fout,int fin_stride);
